...
func LihatInformasiPengguna() {
	...
	fmt.Println("Username             : Nedy")
	fmt.Println("NPM                  : 2406356952")
	fmt.Println("Program Studi        : Produksi Media")
	fmt.Println("Jenis Kelamin        : Perempuan")
	fmt.Println("Tempat/Tanggal Lahir : Jakarta, 19 Januari 2006")
	fmt.Println("==================================")
}
...
func main() {
	...
	var pengguna = Pengguna{"Nedy", "2406356952"}
